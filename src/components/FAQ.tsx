...
ملاحظة: الترقية تتم بتحويل المبلغ لرقم 01080048591 ورفع إيصال الدفع، ويتم التفعيل من الإدارة بعد المراجعة.`
  },
  {
    id: "tasks",
...
4. حوّل المبلغ المطلوب لرقم المحفظة 01080048591
...
نصيحة: استغل فترة التجربة لاستكشاف جميع مزايا التطبيق قبل الترقية!`
  },
  {
    ...
    question: "كيف أنشر إعلاناً في التطبيق؟",
    answer: `يمكنك نشر إعلانك الخاص في التطبيق بسهولة:

1. اذهب إلى قسم "الإعلانات"
2. اضغط على "إنشاء إعلان جديد"
3. اختر تصنيف الإعلان المناسب
4. أضف العنوان والوصف والصور
5. أرسل الإعلان للمراجعة

• الإعلانات المجانية: متاحة للجميع
• الإعلانات المدفوعة: تحصل على أولوية في العرض ومشاهدات أكثر

سيتم مراجعة إعلانك من الإدارة قبل نشره.`
  },
  {
    id: "membership",
    icon: <IdCard className="w-5 h-5" />,
    question: "ما هو رقم العضوية وكيف أستخدمه؟",
    answer: `رقم العضوية هو رقم فريد مكون من 9 أرقام يبدأ بالرقم 6:
