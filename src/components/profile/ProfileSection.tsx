...
export const ProfileSection = ({
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      setCreatedAt((profile as any)?.created_at ?? null);
      setIsVerified(Boolean((profile as any)?.is_verified));
      ...
      const currentBadge = (userBadge as any)?.badges;
        ...
        >
          <CardContent className="py-6 flex items-center gap-4">
            ...
            <div className="flex-1">
              <h3 className="font-bold text-vip-gold">
                لوحة التحكم
              </h3>

              <p className="text-sm text-muted-foreground">
                إدارة التطبيق والمستخدمين
              </p>
            </div>
          </CardContent>
        </Card>
